...
// Gist:    Preprocess syntax prior to parsing and compilation, *preserving* syntax offsets.
...
public:
    Preprocessor(std::vector<SourceBuffer>& buffers, TypedBumpAllocator<std::string> &preBuffers, Diag &diag) :
